        ...
        <AppBar position="sticky">
            <div style={{display: 'flex', font: 'Roboto'}}>
                ...
                <div style={{display: 'flex', flexGrow: 1, justifyContent: 'space-evenly', alignItems: 'center'}}>
                    ...
                    <Button color="inherit" href="/requests" style={{textTransform: 'none'}}><h3>Browse Requests</h3></Button>
                    <Button color="inherit" href="/request" style={{textTransform: 'none'}}><h3>Request a Feature</h3></Button>
                </div>
            </div>
        </AppBar>
    )
